...
public class Detail_DayVo {
	...
	public Date getDetail_progressday() {
		return detail_progressday;
	}
	public void setDetail_progressday(Date detail_progressday) {
		this.detail_progressday = detail_progressday;
	}
