        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2>고양이 간식</h2>
                        <p>잠들어야만 입장 가능한 꿈 백화점에서 일어나는 비밀스럽고도 기묘하며 가슴 뭉클한 판타지 소설</p>
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2>실시간 후기</h2>
                        <p>지금 페니는 첫 번째 제자의 후손과 세 번째 제자의 후손이 정답게 이야기를 나누는 역사적인 현장에 있을 뿐만 아니라, 손을 뻗으면 닿을 거리에 예지몽이 가득한 놀라운 현장에 있? </p>
                    </div>
                </div>
            </div>
            <div class="row">
